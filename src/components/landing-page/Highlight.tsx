...
export default function Highlight() {
	return (
		<section className="w-full mt-48 bg-gradient-to-r from-[#6DACE7] to-[#2764F5] rounded-full">
			<article className="px-8 max-w-screen-xl m-auto flex justify-center gap-x-6 items-center py-12">
				<AnimationReveal className="w-1/2">
